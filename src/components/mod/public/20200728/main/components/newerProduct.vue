    ...
    <swiper-product
        ...
        <template slot="default" slot-scope="{product}">
            ...
            <div class="pro-price" v-if="product.customLabelOne && product.customLabelTwo">
                <p class="pro-tag" :style="{color: options.tag_color, backgroundColor: options.tag_bg_color}">新人价</p>
...
/deep/ .swiper-newer-pro {
    ...
    .swiper-pro-item {
        ...
        &:first-child {
            border-top-left-radius: 10px/@p;
            border-bottom-left-radius: 10px/@p;
        }
...
/deep/ .sales-more-pro.sales-pro {
        .swiper-pro-item {
            height: 284px/@p !important;
            opacity: 0;
        }
    }
</style>
