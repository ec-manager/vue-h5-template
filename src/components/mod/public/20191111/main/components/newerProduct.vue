<template>
    <swiper-product :pid="parames.plate_id" :skuNum="skuNum" wrapClass="swiper-newer-pro" class="newer-pro-wrap" :eventType="1" :style="{background: parames.bg_color, border: borderColor}" v-if="isNewer">
...
export default {
    ...
    computed: {
        borderColor () {
            return '0.067rem solid ' + this.parames.border_color;
        }
    }
};
</script>
...
@import '~@/mod/public/20191111/secondary/style/common.less';
