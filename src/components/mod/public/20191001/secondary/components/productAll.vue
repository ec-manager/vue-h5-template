...
/**
 * @author melody
 * @des 6周年 总sku，根据type为more_info，分为展示tags或不展示tags，根据cols，展示不同的列
 * @params options：楼层配置
...
// 带tags list sku，2或3列
import ProductTags from '@/mod/public/20191001/secondary/components/productTags';
// 爆款 sku，1、 2、 3列
import ProductHot from '@/mod/public/20191001/secondary/components/productHot';
// 优惠券信息，2列或3列
import ProductTps from '@/mod/public/20191001/secondary/components/productTps';
// 普通sku，2或3列，展示配置促销信息，如9月1日价等
import ProductCommon from '@/mod/public/20191001/secondary/components/productCommon';
// 1行多列sku，普通sku，不展示tags 和 tps信息，展示促销配置信息，如9月1日价等
import ProductSwiper from '@/mod/public/20191001/secondary/components/productSwiper';
export default {
    name: 'productAll',
    props: {
        options: {
